...
#define BSP_MATH_TRIG_TABLE_SIZE 1024 /* FULL 1025 项 × 4B ≈ 4.0 KB flash */
#elif BSP_MATH_TRIG_LUT_PREC == 1
#define BSP_MATH_TRIG_TABLE_SIZE 2048 /* FULL 2049 项 × 4B ≈ 8.0 KB flash */
#elif BSP_MATH_TRIG_LUT_PREC == 2
#define BSP_MATH_TRIG_TABLE_SIZE 4096 /* FULL 4097 项 × 4B ≈ 16.0 KB flash */
#elif BSP_MATH_TRIG_LUT_PREC == 3
#define BSP_MATH_TRIG_TABLE_SIZE 8192 /* FULL 8193 项 × 4B ≈ 32.0 KB flash */
#else
...
#if BSP_MATH_TRIG_LUT_PREC == 0
#define BSP_MATH_TRIG_TABLE_SIZE 256 /* QUARTER 257 项 × 4B ≈ 1.0 KB flash */
#elif BSP_MATH_TRIG_LUT_PREC == 1
#define BSP_MATH_TRIG_TABLE_SIZE 512 /* QUARTER 513 项 × 4B ≈ 2.0 KB flash */
#elif BSP_MATH_TRIG_LUT_PREC == 2
#define BSP_MATH_TRIG_TABLE_SIZE 1024 /* QUARTER 1025 项 × 4B ≈ 4.0 KB flash */
#elif BSP_MATH_TRIG_LUT_PREC == 3
#define BSP_MATH_TRIG_TABLE_SIZE 2048 /* QUARTER 2049 项 × 4B ≈ 8.0 KB flash */
#else
#error "BSP_MATH_TRIG_LUT_PREC 必须为 0..3（0=低 1=中 2=高 3=满精度）"
#endif
#else
