...
typedef struct { DAC_HandleTypeDef *handle; uint32_t channel; } DAC_Map_t;

/*============================================
 *              板载资源枚举
 *============================================*/
typedef enum { GPIO_OLED_KEY = 0, GPIO_OLED_DC, GPIO_OLED_RST,
    GPIO_USER_KEY, GPIO_MPU6500_INT, GPIO_IST8310_RSTN, GPIO_IST8310_DRDY,
    GPIO_LED_R, GPIO_LED_G, GPIO_SD_EXTI, GPIO_LASER,
    GPIO_POWER_EN1, GPIO_POWER_EN2, GPIO_POWER_EN3, GPIO_POWER_EN4,
    GPIO_DAC_EXTI, GPIO_NUM_MAX } BoardGPIO_e;

typedef enum { TIM_HEATER = 0, TIM_BUZZER,
    TIM_PWM_3Pin1, TIM_PWM_3Pin2, TIM_PWM_3Pin3, TIM_PWM_3Pin4,
    TIM_PWM_1, TIM_PWM_2, TIM_PWM_3, TIM_PWM_4, TIM_PWM_5, TIM_PWM_6,
    TIM_PWM_7, TIM_PWM_8, TIM_PWM_9, TIM_PWM_10, TIM_PWM_11, TIM_PWM_12,
    TIM_PWM_13, TIM_PWM_14, TIM_PWM_15, TIM_PWM_16,
    TIM_NUM_MAX } BoardTIM_e;

typedef enum { UART_SBUS = 0, UART_2, UART_3, UART_7, UART_8,
    UART_4Pin_6, UART_NUM_MAX } BoardUART_e;

typedef enum { CAN_1 = 0, CAN_2, CAN_NUM_MAX } BoardCAN_e;
typedef enum { SPI_OLED = 0, SPI_EX_4, SPI_MPU6500, SPI_NUM_MAX } BoardSPI_e;
typedef enum { I2C_EX_2 = 0, I2C_NUM_MAX } BoardI2C_e;

typedef enum { ADC1_EX_8 = 0, ADC1_EX_9, ADC1_EX_10, ADC1_EX_11,
    ADC1_EX_12, ADC1_EX_13, ADC1_EX_14, ADC1_EX_15,
    ADC3_4, ADC3_5, ADC3_EX_8, ADC_NUM_MAX } BoardADC_e;

typedef enum { DAC_1 = 0, DAC_2, DAC_NUM_MAX } BoardDAC_e;
