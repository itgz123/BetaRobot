...
<span class="line"><span>}</span></span></code></pre></div><h2 id="_2-3-链接脚本语法详解" tabindex="-1">2.3 链接脚本语法详解 <a class="header-anchor" href="#_2-3-链接脚本语法详解" aria-label="Permalink to &quot;2.3 链接脚本语法详解&quot;">​</a></h2><h3 id="_2-3-1-基本结构" tabindex="-1">2.3.1 基本结构 <a class="header-anchor" href="#_2-3-1-基本结构" aria-label="Permalink to &quot;2.3.1 基本结构&quot;">​</a></h3><div class="language-ld vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ld</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/* ==================== 入口点定义 ==================== */</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><h3 id="_2-3-2-段定义语法" tabindex="-1">2.3.2 段定义语法 <a class="header-anchor" href="#_2-3-2-段定义语法" aria-label="Permalink to &quot;2.3.2 段定义语法&quot;">​</a></h3><div class="language-ld vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ld</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>SECTIONS</span></span>
<span class="line"><span>{</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">};</span></span></code></pre></div><h3 id="_2-4-3-链接脚本配套定义" tabindex="-1">2.4.3 链接脚本配套定义 <a class="header-anchor" href="#_2-4-3-链接脚本配套定义" aria-label="Permalink to &quot;2.4.3 链接脚本配套定义&quot;">​</a></h3><div class="language-ld vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ld</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/* 在SECTIONS中添加自定义段 */</span></span>
<span class="line"><span></span></span>
